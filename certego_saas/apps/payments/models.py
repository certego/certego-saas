...
class Customer(models.Model):
    ...
    @property
    def _dragonfly_subscription(self) -> "Subscription":
        try:
    ...
    @property
    def _intelowl_subscription(self) -> "Subscription":
        try:
    ...
    @property
    def _subscriptions_map(self) -> Dict[str, "Subscription"]:
        return {
            AppChoices.DRAGONFLY: self._dragonfly_subscription,
            AppChoices.INTELOWL: self._intelowl_subscription,
        }
